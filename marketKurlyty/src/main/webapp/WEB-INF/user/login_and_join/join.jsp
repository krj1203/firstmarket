		...
		<div id="container">
			...
			<div id="main">
											...
											<td>
												...
												<div class="check_view">
													<label class="check_agree label_block"> <inputtype
															="checkbox" value="" name="agree" required=""
                ...
                serviceView.update();
						...
						<script
							src="/shop/data/skin/designgj/js/pw_validate.js?ver=1.40.4"></script>
						<script
							src="/shop/data/skin/designgj/js/delivery_address.js?ver=1.40.4"></script>
