		...
		<div id="container">
			...
			<div id="main">
					...
					<div class="page_aticle">
						...
						<div class="type_form member_join ">
							<form id="form" name="frmMember" method="post" action="/shop/member/indb.php" onsubmit="return chkForm2(this)" novalidate="">
								...
								<input
									type="hidden" name="check_mobile" value="">
									...
									<input type="hidden" name="return_url"value="https://www.kurly.com/shop/mypage/mypage_orderlist.php">
								<p class="page_sub">
								...
								<table class="tbl_comm">
									<tbody>
										...
										<tr class="field_phone">
											...
											<td>
												...
												<div id="codeNum" class="code_num">
													<input type="text" name="auth_code" id="auth_code" value="" size="6" maxlength="6" 
														pattern="[0-9]*" label="인증번호 확인" disabled="" class="inp_confirm"
										...
										<tr>
											...
											<td class="field_address"><input type="hidden" name="zonecode" id="zonecode" size="5" value="">
											...
											<td>
												...
												<div class="check_view">
													<label class="check_agree label_block">
														<inputtype="checkbox" value="" name="agree" required="" label="이용약관">
												...
												<div class="layer layer_agreement" style="display: none; margin-top: -299.5px;">
													<div class="inner_layer">
														<h4 class="tit_layer"> 이용약관 <span class="sub">(필수)</span>
														</h4>
                ...
                serviceView.update();
												...
												<div class="check_view">
													<label class="check_agree label_block">
													<inputtype="checkbox" id="private1" name="private1" value="" required="" label="개인정보 수집·이용">
													<span class="ico"></span>개인정보수집·이용 동의 <span class="sub">(필수)</span>
													</label>
													...
													<div class="inner_layer">
														<div class="in_layer">
															...
															<p class="txt_service">서비스 제공을 위해서 필요한 최소한의 개인정보입니다.
																동의를 해 주셔야 서비스를 이용하실 수 있으며, 동의하지 않으실 경우 서비스에 제한이 있을 수 있습니다.
															</p>
														</div>
						...
						<script src="/shop/data/skin/designgj/js/pw_validate.js?ver=1.40.4"></script>
						<script src="/shop/data/skin/designgj/js/delivery_address.js?ver=1.40.4"></script>
