...
<link rel="stylesheet" href="${pageContext.request.contextPath }/resources/style/customerCenter/largeInquiryWrite.css">
<link rel="styleSheet" href="largeInquiryWrite.css">
</head>
